...
import { Code, Database, Globe, Server, GraduationCap, PackageIcon, LayoutDashboard } from "lucide-react"
  ...
  const highlights = [
    {
      ...
      description: "React.js, Next.js, JavaScript, TypeScript",
    },
    {
      icon: <Server className="h-6 w-6" />,
      title: "Backend Development",
      description: "Node.js, Express.js, Nest.js, RESTful APIs",
    },
    {
      icon: <Database className="h-6 w-6" />,
      title: "Database & Cloud",
      description: "MongoDB, MySQL, PostgreSQL, AWS, Docker",
    },
    {
      icon: <Globe className="h-6 w-6" />,
      title: "Other",
      description: "Payment Gateway Integration, Strapi-CMS, Contentful",
    },
  ]
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            Fullstack Developer with 5+ years of experience in web development using React.js,Next.js,Node.js, MongoDB, and AWS
            services. Proven track record in building scalable web applications and RESTful APIs.
          </p>
        </motion.div>
