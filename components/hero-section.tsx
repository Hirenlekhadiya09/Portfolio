    ...
    >
      ...
      <div className="container mx-auto px-4 text-center relative z-10">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
          ...
          >
            Fullstack Developer with 5+ years of experience in React, Node.js, Next.js, MongoDB and AWS services. Proven track record
          ...
          >
            {[
              { icon: Github, href: "https://github.com/Hirenlekhadiya09" },
              { icon: Linkedin, href: "https://www.linkedin.com/in/hiren-lekhadiya-a909681a6" },
              { icon: Mail, href: "mailto:hirenlekhadiya@gmail.com" },
            ].map((social, index) => (
